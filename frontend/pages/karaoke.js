  ...
  return (
    <>
      ...
      <div style={{width: '640px', height: '360px', display: 'flex', flexDirection: "column",justifyContent: 'start', alignItems: 'start'}}>
        ...
        <div style={{width: '100%', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem'}}>
        ...
        <p style={{marginTop: '0.5rem', fontSize: '1.5rem', marginBottom: '1rem'}} >Comments</p>
        <Comments />
      </div>
    </>
  )
